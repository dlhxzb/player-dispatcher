...
pub const DEFAULT_MAX_PLAYERS: u32 = 1000; // 服务器最大用户数，触发扩容
pub const DEFAULT_MIN_PLAYERS: u32 = DEFAULT_MAX_PLAYERS / 4; // 服务器最小用户数，触发缩容
pub const DEFAULT_MAX_ZONE_DEPTH: u32 = 10; // 四叉树最大深度
